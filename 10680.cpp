...
void ans_maker()
{
    for(LLD i=0;i<1000015;i++)ans[i]=1;
    ...
    for(int i=0;i<1000015;i++)
    {
        if(ans[i]!=1)
        {
            tmp_ans=tmp_ans*ans[i];
            while(tmp_ans%10==0)tmp_ans=tmp_ans/10;
            tmp_ans=tmp_ans%100000000;
        }
        ans[i]=(int)(tmp_ans%10);
    }
}
