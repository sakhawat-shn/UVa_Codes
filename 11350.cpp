...
void finder(int n,pll mid,pll l,pll r)
{
    if(n==s.size())
    {
    ...
    if(s[n]=='R')
    {
        finder(n+1,mkp(mid.F+r.F,mid.S+r.S),mid,r);
    }
    else
    {
        finder(n+1,mkp(l.F+mid.F,l.S+mid.S),l,mid);
    }
}
...
int main()
{
    ...
    {
        cin>>s;
        finder(0,mkp((LLD)1,(LLD)1),mkp((LLD)0,(LLD)1),mkp((LLD)1,(LLD)0));
    }
